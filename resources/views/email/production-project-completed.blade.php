...
<head>
    <meta charset="UTF-8">
    <title>{{ $crmName }} Project Completed</title>
</head>
    ...
    <div style="max-width:640px; margin:auto; overflow:hidden; background:#ffffff; border-radius:14px;">
        ...
        <div style="padding:40px;">
            ...
            <h2 style="margin:0 0 18px; color:#111827; font-size:26px;">
                Your author's/client's project is now complete
            </h2>

            <p style="margin:0 0 22px; color:#374151; font-size:15px; line-height:1.6;">
                The production project below has reached 100% completion.
            </p>

            <div style="background:#f8fafc; border:1px solid #e5e7eb; border-radius:12px; padding:18px; margin:0 0 24px;">
                <p style="margin:0 0 10px; color:#64748b; font-size:12px; font-weight:bold; text-transform:uppercase;">Project ID</p>
                <p style="margin:0 0 16px; color:#111827; font-size:15px; font-weight:bold;">{{ $projectCode }}</p>
                ...
                <p style="margin:0 0 10px; color:#64748b; font-size:12px; font-weight:bold; text-transform:uppercase;">Service Category</p>
                <p style="margin:0; color:#111827; font-size:15px; font-weight:bold;">{{ str($project->tracker_type)->title() }}</p>
            </div>
