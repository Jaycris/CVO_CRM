...
class RewardController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'reward_scope' => ['required', Rule::in([Reward::SCOPE_INDIVIDUAL, Reward::SCOPE_TEAM])],
            'audience' => ['required', Rule::in([Reward::AUDIENCE_ALL, Reward::AUDIENCE_COMMISSION_ELIGIBLE])],
